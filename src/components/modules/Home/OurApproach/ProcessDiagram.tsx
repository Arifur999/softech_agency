...
export function ProcessDiagram() {
  ...
  return (
    <div className="flex items-center justify-between gap-2" aria-hidden>
      <svg viewBox="0 0 90 96" className="h-[86px] w-[80px] shrink-0 lg:h-[104px] lg:w-[96px]">
      ...
      <svg viewBox="0 0 40 8" className="h-2 w-6 shrink-0">
        <line
          x1="0"
          y1="4"
          x2="40"
      ...
      <span className="inline-flex size-[52px] shrink-0 items-center justify-center rounded-[14px] bg-[#eaf2fe] lg:size-[62px]">
      ...
      <svg viewBox="0 0 120 96" className="h-[86px] w-[110px] shrink-0 lg:h-[104px] lg:w-[130px]">
