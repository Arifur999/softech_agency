...
export function WhatIsSoftechSection() {
  return (
    ...
    >
      <Reveal variant="left" className="w-full shrink-0 lg:w-auto">
      <Image
      ...
      <div className="flex w-full flex-col gap-10 lg:gap-[102px]">
        <Reveal variant="right" className="flex flex-col gap-3">
          <SectionIntro
            {...WHAT_IS_SOFTECH_INTRO}
        ...
        <RevealGroup className="flex flex-col gap-2 sm:flex-row sm:items-stretch" itemClassName="flex flex-1">
